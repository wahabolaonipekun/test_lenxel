						...
						if ( isset( $field['validate'] ) ) {
							...
							foreach ( $val_arr as $idx => $val ) {
								...
								if ( ! class_exists( $validate ) ) {
									...
									/**
									 * Filter 'redux/validate/{opt_name_triger}/class/{field.validate}'
									 *
									...
									$class_file = apply_filters( "redux/validate/{$core->args['opt_name_triger']}/class/$val", Redux_Core::$dir . "inc/validation/$val/class-redux-validation-$file.php", $validate );
