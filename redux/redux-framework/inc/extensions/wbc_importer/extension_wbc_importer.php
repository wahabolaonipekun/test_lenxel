    ...
    class ReduxFramework_extension_wbc_importer {
        ...
        function add_importer_section() {
            ...
            $this->parent->sections[] = array(
                ...
                'desc'   => '<p class="description">'. apply_filters( 'wbc_importer_description', esc_html__( 'Install on a new wordpress installation to aviod duplicate data', 'framework' ) ).'</p>',
