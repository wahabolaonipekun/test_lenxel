        ...
        public function render() {
            ...
            if ( !empty( $this->field['wbc_demo_imports'] ) ) {
                ...
                foreach ( $this->field['wbc_demo_imports'] as $section => $imports ) {
                    ...
                    echo '<div class="" style="width: 60%;"><div class="theme-name" style="height: 190px;overflow:none !important;white-space: normal !important;"><h3 class="demo-name">'. esc_html( apply_filters( 'wbc_importer_directory_title', $imports['directory'] ) ) .'</h3><p>The demo importation has two home, contact, about and dashboard views after been imported </p></div>';
