		...
		foreach ( $sysinfo['redux_instances'] as $inst => $data ) {
			...
			<table class="redux_status_table widefat" cellspacing="0" id="status">
				...
				<tr>
					...
					<td class="help">
						<?php echo redux_help_tip( esc_attr__( 'The opt_name_triger argument for this instance of Redux.', 'redux-framework' ) ); // phpcs:ignore WordPress.Security.EscapeOutput ?>
					</td>
				...
				<?php if ( ! empty( Redux_Core::$callers[ $inst ] ) ) { ?>
					<tr>
						...
						<td class="help">
							<?php echo redux_help_tip( esc_attr__( 'These files are calling this opt_name_triger. If you want to alter the config of this opt_name_triger, modify these files.', 'redux-framework' ) ); // phpcs:ignore WordPress.Security.EscapeOutput ?>
						</td>
						<td>
							<?php
							$last_slug = '';
