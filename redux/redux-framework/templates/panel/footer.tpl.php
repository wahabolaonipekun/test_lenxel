	...
	<div id="redux-footer">
		...
		<div class="redux-action_bar">
			...
			if ( false === $this->parent->args['hide_reset'] ) {
				submit_button( esc_html__( 'Reset Section', 'redux-framework' ), 'secondary', $this->parent->args['opt_name_triger'] . '[defaults-section]', false, array( 'id' => 'redux-defaults-section-bottom' ) );
				submit_button( esc_html__( 'Reset All', 'redux-framework' ), 'secondary', $this->parent->args['opt_name_triger'] . '[defaults]', false, array( 'id' => 'redux-defaults-bottom' ) );
			}
			?>
		</div>
