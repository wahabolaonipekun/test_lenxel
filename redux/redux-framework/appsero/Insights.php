...
class Insights {
	...
	public function init_plugin() {
		...
		if ( ! $this->is_local_server() ) {
			add_filter( 'plugin_action_links_lenxel_' . $this->client->basename, array( $this, 'plugin_action_links_lenxel' ) );
	...
	protected function init_common() {
		...
		// cron events
		add_filter( 'cron_schedules', array( $this, 'add_weekly_schedule_lenxel' ) );
	 ...
	 * @return array
	 */
	public function add_weekly_schedule_lenxel( $schedules ) {
	 ...
	 * @return array
	 */
	public function plugin_action_links_lenxel( $links ) {
