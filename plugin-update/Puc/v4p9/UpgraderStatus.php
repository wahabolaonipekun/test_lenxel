...
if ( !class_exists('Puc_v4p9_UpgraderStatus', false) ):
	...
	class Puc_v4p9_UpgraderStatus {
		...
		public function __construct() {
			...
			add_filter('upgrader_pre_install', array($this, 'setUpgradedThingLenxel'), 10, 2);
			add_filter('upgrader_package_options', array($this, 'setUpgradedPluginFromOptionsLenxel'), 10, 1);
			add_filter('upgrader_post_install', array($this, 'clearUpgradedThingLenxel'), 10, 1);
			add_action('upgrader_process_complete', array($this, 'clearUpgradedThingLenxel'), 10, 1);
		}
		 ...
		 */
		public function setUpgradedThingLenxel($input, $hookExtra) {
		 ...
		 * @return array
		 */
		public function setUpgradedPluginFromOptionsLenxel($options) {
		 ...
		 * @return mixed Returns $input unaltered.
		 */
		public function clearUpgradedThingLenxel($input = null) {
			$this->currentId = null;
			$this->currentType = null;
			return $input;
		}
